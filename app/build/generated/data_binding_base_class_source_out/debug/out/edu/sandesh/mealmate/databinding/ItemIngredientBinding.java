...
public final class ItemIngredientBinding implements ViewBinding {
  ...
  @NonNull
  public final GridLayout ingredientGrid;

  private ItemIngredientBinding(@NonNull LinearLayout rootView,
      @NonNull GridLayout ingredientGrid) {
  ...
  public static ItemIngredientBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.ingredientGrid;
      GridLayout ingredientGrid = ViewBindings.findChildViewById(rootView, id);
      if (ingredientGrid == null) {
        break missingId;
      }

      return new ItemIngredientBinding((LinearLayout) rootView, ingredientGrid);
    }
